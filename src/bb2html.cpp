...
namespace quickbook
{
    namespace detail
    {
        ...
        void generate_docinfo_html(html_gen& gen, xml_element* x)
        {
            ...
            quickbook::detail::out() << "Authors:" << std::endl;
            QUICKBOOK_FOR (auto const& author, d.authors) {
                quickbook::detail::out() << "- " << author << std::endl;
            }
        }
...
#define NODE_MAP_CLASS(tag_name, html_name, class_name)                        \
    ...
    {                                                                          \
        ...
        // volumenum
        // personname, honorific, firstname, surname, lineage, othername, affiliation, authorblurb, contrib - add to authors?
