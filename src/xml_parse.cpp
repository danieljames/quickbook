...
namespace quickbook { namespace detail {
    ...
    void write_xml_tree_impl(std::string& out, xml_element* node, unsigned int depth);
    ...
    void read_tag(xml_tree_builder&, string_iterator& it, string_iterator start, string_iterator end);
    void read_close_tag(xml_tree_builder&, string_iterator& it, string_iterator start, string_iterator end);
    ...
    void read_tag(xml_tree_builder& builder, string_iterator& it, string_iterator start, string_iterator end) {
        ...
        while (true) {
            ...
            node->set_attribute(attribute_name, quickbook::detail::decode_string(attribute_value));
        }
    }
