...
#define PO_VALUE po::value
        ...
        desc.add_options()
            ...
            ("output-file", PO_VALUE<command_line_string>(), "output file (boostbook or onehtml)")
        ...
        if (vm.count("input-file"))
        {
            ...
            if (vm.count("css-path")) {
                options.html_ops.css_path = quickbook::detail::command_line_to_path(
                        vm["css-path"].as<command_line_string>());
            }

            if (vm.count("graphics-path")) {
                options.html_ops.graphics_path = quickbook::detail::command_line_to_path(
            ...
            {
                options.xinclude_base = options.style == parse_document_options::output_chunked ?
                    options.output_path : options.output_path.parent_path();
