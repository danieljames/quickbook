...
namespace quickbook { namespace detail {
    ...
    void tag_end(html_printer& printer) {
        printer.html += ">";
    }

    void tag_end_self_close(html_printer& printer) {
        printer.html += "/>";
    }

    void tag_attribute(html_printer& printer, quickbook::string_view name, quickbook::string_view value) {
        printer.html += " ";
        printer.html.append(name.begin(), name.end());
        printer.html += "=\"";
